...
/**
 * Inspect the inferred strategies for a given module or function to test.
 */
public class InspectAction extends AnAction {
    /**
     * Specify and run the "icontract-hypothesis test --inspect" command as a run configuration.
     *
    ...
    public void actionPerformed(@NotNull AnActionEvent event) {
        ...
        String runName = String.format("icontract-hypothesis inspect %s", target);

        var scriptParameters = new ArrayList<String>();
        scriptParameters.add("test");
        scriptParameters.add("--inspect");
    ...
    public void update(@NotNull AnActionEvent event) {
        ...
        presentation.setText(String.format("inspect strategy for %s", target), false);
        presentation.setDescription(
                String.format("Infer the Hypothesis strategy for %s and inspect it", target));
